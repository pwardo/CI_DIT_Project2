...
class acl {
    ...
    function getUserRoles() {
        //$strSQL = "SELECT * FROM `".DB_PREFIX."acl_user_roles` WHERE `userID` = " . floatval($this->userID) . " ORDER BY `addDate` ASC";
    ...
    function getRolePerms($role) {
        if (is_array($role)) {
            //$roleSQL = "SELECT * FROM `".DB_PREFIX."acl_role_perms` WHERE `roleID` IN (" . implode(",",$role) . ") ORDER BY `ID` ASC";
            $this->ci->db->where_in('roleID', $role);
        } else {
            //$roleSQL = "SELECT * FROM `".DB_PREFIX."acl_role_perms` WHERE `roleID` = " . floatval($role) . " ORDER BY `ID` ASC";
    ...
    function getUserPerms($userID) {
        //$strSQL = "SELECT * FROM `".DB_PREFIX."acl_user_perms` WHERE `userID` = " . floatval($userID) . " ORDER BY `addDate` ASC";
